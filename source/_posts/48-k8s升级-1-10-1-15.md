...
<center>
<img src="http://zhangzw001.github.io/images/dockerniu.jpeg" width = "100" height = "100" style="border: 0"/>
<font color="blue" face="黑体" size=5> k8s1.15.0 -> k8s1.15.9 </font>
</center>
...
COMPONENT            CURRENT   AVAILABLE
API Server           v1.15.0   v1.15.9
Controller Manager   v1.15.0   v1.15.9
Scheduler            v1.15.0   v1.15.9
Kube Proxy           v1.15.0   v1.15.9
CoreDNS              1.3.1     1.3.1
